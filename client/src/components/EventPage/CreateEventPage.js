// components/EventPage/CreateEventPage.js
    ...
    <div className="max-w-4xl mx-auto mt-8 shadow-lg p-4 border-2 border-indigo-400 rounded-lg bg-white">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <input type="file" name="image" id="image" onChange={handleFileChange} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 p-2" />
        </div>
